...
class AsyncDocumentationCrawler:
    def __init__(
        ...
        self.logger.debug(f"base_url: {base_url}, base_domain: {self.base_domain}")
    ...
    def _is_valid_url(self, url: str) -> bool:
        ...
        try:
            ...
            return (
                ...
                and not any(
                    ext in url.lower()
                    for ext in [ # 这种方式不太好，容易抓到遗漏的文件类型
                        ".pdf",
                        ".zip",
                        ".exe",
                        ".jpg",
    ...
    async def crawl(self):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                self.logger.info(
                    f"Crawling completed. Total pages: {len(self.visited_urls)}"
                )
